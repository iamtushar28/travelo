...
const TravelPoints = () => {
    return (
        <div className='pt-44 pb-10 w-full flex flex-col md:flex-row items-center gap-16 md:gap-20'>

            {/* visuals section */}
            <div className='h-80 w-full md:w-[40%] bg-[#FACD49] rounded-r-full relative'>
                ...
                <div className='h-8 w-8 bg-[#2FD9B9] rounded-full absolute top-0 right-4 md:left-12 md:-top-10 blur-xs'></div>
            ...
            <button className='md:hidden h-16 w-16 -mt-36 text-white bg-[#FACD49] rounded-full flex justify-center items-center absolute -bottom-14 right-4'>
            ...
            <div className='md:-mt-32 px-4'>
                ...
                <p className='md:w-96 text-sm text-[#A8A8A8] mt-2'>Hay! Travelo there to help you find your dream holiday. Easy you just find where you want to go and buy the ticket.</p>

                {/* cards 1 */}
                <div className='mt-8 flex justify-center gap-6'>

                    {/* card 1 */}
                    <div className='w-36 h-28 md:w-48 md:h-28 border border-zinc-200 rounded-3xl flex flex-col justify-center items-center'>
            ...
            {/* video visual element */}
            <button className='hidden h-16 w-16 -mt-36 text-white bg-[#FACD49] rounded-full md:flex justify-center items-center'>
                <Image src={TicketStar} alt="TicketStar icon" className='h-10 w-10' />
            </button>
